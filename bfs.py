...
def get_clicked_node():
    ...
    pg.draw.rect(screen, pg.Color('red'), get_grid_rect(grid_x, grid_y))
...
if __name__ == '__main__':
    ...
    while True:
        ...
        [pg.draw.rect(screen, pg.Color("darkslategray"), get_grid_rect(x, y)) for x, y in bfs_queue]
        ...
        if mouse_pos and not grid[mouse_pos[1]][mouse_pos[0]]:
            queue, visited = breadth_first_search(start, mouse_pos, graph)
            goal = mouse_pos
